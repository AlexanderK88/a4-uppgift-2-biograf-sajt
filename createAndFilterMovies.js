...
const addVisibility = (movies) => {
  //Iterating through each movie-card and gives them display block
...
//When you want to have a button or something else where if you click, all movies are shown. This is the code to use.
